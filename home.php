<?php
        ...
        if(isset($_POST['btn-players']) ) {
                header("Location: userplayers.php");
        }
        ...
        <div class="container" id="formContainer">
          ...
          <form class="form-signin" id="userchoice" role="form" method="post" action="" autocomplete="off">
            ...
            <button class="btn btn-lg btn-primary btn-block" type="submit" name="btn-teams">View Teams</button>
                        ...
                        <button class="btn btn-lg btn-primary btn-block" type="submit" name="btn-scores">View Scores</button>
                        <button class="btn btn-lg btn-primary btn-block" type="submit" name="btn-players">View Players</button><br>
